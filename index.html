      ...
      <div class="toolbarShell" role="group" aria-label="Main toolbar">
        <div class="toolbarGroup toolbarTools" aria-label="Tools">
          <div class="toolbarHeader">
            <div class="toolbarLabel">Tools</div>
            <button id="btnToggleToolsMenu" class="toolbarCollapseBtn" type="button" aria-expanded="true" title="Hide tools">⟩</button>
          </div>
        ...
        <div class="toolbarGroup toolbarActions" aria-label="Actions">
          <div class="toolbarHeader">
            <div class="toolbarLabel">Actions</div>
            <button id="btnToggleActionsMenu" class="toolbarCollapseBtn" type="button" aria-expanded="true" title="Hide actions">⟩</button>
          </div>
          <div id="toolbarActionsRow" class="toolbarRow">
            ...
            <button id="btnThemeToggle" title="Toggle light/dark theme">🌙 Dark</button>
          </div>
        </div>
      </div>
</header>

...
btnClear.addEventListener("click", () => { pushUndo(); dungeon.spaces=[]; dungeon.paths=[]; dungeon.shapes=[]; placedTexts=[]; refreshEditSeqCounter(); selectedShapeId=null; selectedTextId=null; draft=null; draftRect=null; freeDraw=null; draftShape=null; eraseStroke=null; syncTextPanelVisibility() })
